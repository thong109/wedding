    ...
    return (
      ...
      (e.emitEvent = function(t, e) {
        ...
        if (i && i.length) {
          (i = i.slice(0)), (e = e || []);
          for (
            let n = this._onceEvents && this._onceEvents[t], o = 0;
            o < i.length;
            o++
          ) {
            const r = i[o],
...
return [];
      ...
      const e = 'object' == typeof t && 'number' == typeof t.length;
      return e ? n.call(t) : [ t ];
    }),
...
return void o.push(t);
              ...
              e(t, n) && o.push(t);
              for (let i = t.querySelectorAll(n), r = 0; r < i.length; r++) {
o.push(i[r]);
}
            }
          }),
...
this.colYs.push(0);
      ...
      (n.measureColumns = function() {
        ...
        let n = (this.columnWidth += this.gutter),
...
return this.colYs[t];
      ...
      (n._manageStamp = function(t) {
        ...
        for (
          let u = this._getOption('originTop'),
